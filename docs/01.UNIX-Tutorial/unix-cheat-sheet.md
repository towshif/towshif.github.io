...
echo $0             # displays the shell you're using
echo $SHELL
...
clear               # clears content on window (hide displayed lines): keyboard shortcut ^L 
...
who                      # return all users who all logged in
...
tr```ap - DEBUG  # turn off the DEBUG trap
